  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.bg }}>
      {/* automaticallyAdjustKeyboardInsets statt KeyboardAvoidingView: Mit der
          ...
          wenig — der Speichern-Button blieb hinter der iOS-Tastatur. */}
      <ScrollView
      ...
      >
        ...
        <NachweisSektion
          ...
          nachweisVorhanden={nachweisVorhanden}
          uploadBtnStyle={styles.uploadBtnAbstand}
        />
        ...
        <AnhaengeSektion
          anhaenge={anhaenge}
          setAnhaenge={setAnhaenge}
          titel="Weitere Anhänge (optional)"
          uploadBtnStyle={styles.uploadBtnAbstand}
        />
...
const styles = StyleSheet.create({
  ...
  // Der Upload-Button hatte in diesem Screen (anders als in bewerben.tsx)
  // marginTop: 6 — wird den Sektionen als uploadBtnStyle mitgegeben.
  uploadBtnAbstand: { marginTop: 6 },
  summary: {
    flexDirection: 'row',
